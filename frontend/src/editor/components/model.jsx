...
const Model = ({
    ...
    if (object.mesh) {
      if (originalMaterials[mesh.uuid] && originalMaterials[mesh.uuid].clone) {
        ...
        newMaterial = new THREE.MeshPhysicalMaterial({
          ...
          normalMap: normalMap,
          opacity:
            object.material.opacity === undefined ? 1 : object.material.opacity,
          transparent: object.material.opacity < 1,
          side: newSide,
          reflectivity:
            object.material.reflectivity === undefined
              ? 0
              : object.material.reflectivity,
          shininess:
            object.material.shininess === undefined
              ? 30
              : object.material.shininess,
          ior: object.material.ior === undefined ? 1.5 : object.material.ior,
          transmission:
            object.material.transmission === undefined
              ? 0
              : object.material.transmission,
          clearcoat:
            object.material.clearcoat === undefined
              ? 0
              : object.material.clearcoat,
          clearcoatRoughness:
            object.material.clearcoatRoughness === undefined
              ? 0
              : object.material.clearcoatRoughness,
          sheen:
            object.material.sheen === undefined ? 0 : object.material.sheen,
          sheenRoughness:
          ...
          castShadow:
            object.material.castShadow !== undefined
              ? object.material.castShadow
              : false, // Default to false if undefined
          receiveShadow:
            object.material.receiveShadow !== undefined
              ? object.material.receiveShadow
      ...
      newMaterial = new THREE.MeshPhysicalMaterial({
        ...
        sheenRoughness:
          object.material.sheenRoughness === undefined
            ...
            : object.material.sheenRoughness,
        thickness:
          object.material.thickness === undefined
            ? 0
  ...
  useFrame(() => {
    if (meshRef.current) {
      ...
      if (material && !object.mesh) {
        ...
        if (
          object.material &&
          object.material.custom !== undefined &&
          meshRef.current.material.userData
        ) {
  ...
  return (
    <>
      {isSelected && (
        <TransformControls ref={transformRef} mode="translate" space="world" />
      )}
      {object.mesh ? (
        meshReady &&
        meshRef.current && (
